export const popularDestinations = [
  ...
  },
  {
    ...
    description:
      "Gilgit-Baltistan is home to five of the world's fourteen peaks above 8,000 meters and some of the most spectacular mountain scenery anywhere on Earth. Travelers can experience dramatic landscapes while discovering centuries-old traditions and communities that have thrived in these mountains for generations.",
    highlights: [
      "Towering peaks",
...
export const beyondPakistan = {
  title: "Beyond Pakistan: The Silk Road & Central Asia",
  description:
    "For travelers wishing to extend their journey beyond Pakistan, Mountain Travels Pakistan also offers carefully crafted tours across the ancient Silk Road and Central Asia. Explore the legendary cities of Samarkand, Bukhara, Khiva, Bishkek, Almaty, Dushanbe, and the Pamir Mountains while following the routes that connected civilizations for centuries.",
  closing:
