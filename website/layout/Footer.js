            ...
            >
              ...
              <div className="footer-widget footer-contact">
                ...
                <ul className="list-style-one">
                  <li>
                    <i className="fal fa-map-marked-alt" /> Ghangchan House, Aliabad
                    Satellite Town, Skardu City
                    Gilgit-Baltistan, Pakistan
                  </li>
                  <li>
                    <i className="fal fa-envelope" />{" "}
                    <a href="mailto:info@mountaintravels.com">
                      info@mountaintravels.com
                    </a>
                  </li>
                  <li>
                    <i className="fal fa-phone-volume" />{" "}
                    <a href="callto:+923468486900 ">+92 346 8486900 </a>
                  </li>
                </ul>
              </div>
              <div className="social-style-one mt-15">
                <Link href="https://www.facebook.com/mountaintravels/">
          ...
          <div className="row">
            <div className="col-lg-5">
              <div className="copyright-text text-center text-lg-start">
                <p>
                  © 2025 Mountain Travels Pakistan. All Rights Reserved,
                </p>
              </div>
            </div>
            <div className="col-lg-7 text-center text-lg-end">
              <p>Developed by <a href="https://netbots.tech/">NetBots</a></p>
            </div>
          </div>
          {/* Scroll Top Button */}
