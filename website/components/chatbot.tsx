...
export function Chatbot() {
  ...
  const submitUserInfo = async (info: UserInfo) => {
    ...
    try {
      ...
      addBotMessage(
        "Oh no! 😟 It seems our messenger pigeon got lost. Could you please try reaching out to us directly at info@mountaintravels.com? We'd hate to miss out on helping you!",
      )
    }
    setIsTyping(false)
  }
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      setError("Oops! I'm having a bit of trouble connecting right now.");
