...
export default function CorporateModal({ open, onClose }: CorporateModalProps) {
  if (!open) return null
  ...
  return (
    <div className="fixed inset-0 z-[999] flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative bg-white w-[95%] max-w-5xl max-h-[90vh] rounded-3xl shadow-2xl overflow-hidden">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        {/* Scrollable Content */}
        <div className="overflow-y-auto max-h-[90vh] px-6 py-8 md:px-12 md:py-14">
