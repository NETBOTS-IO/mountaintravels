...
const page = () => {
  return (
              ...
              {[
    {
      icon: "flaticon-tent",
      title: "Tent Camping",
      description: "Tent camping is a wonderful way to connect with nature",
      link: "tour-details",
    },
    {
      icon: "flaticon-kayak",
      title: "Kayaking",
      description: "Kayaking is a thrilling outdoor activity for adventurers",
      link: "tour-details",
    },
    {
      icon: "flaticon-mountain-bike",
      title: "Mountain Biking",
      description:
        "Mountain biking is an exhilarating sport that builds physical fitness",
      link: "tour-details",
    },
    {
      ...
      title: "Fishing & Boat",
      description:
        "Fishing and boating are quintessential activities that bring joy",
      link: "tour-details",
    },
  ].map((feature, index) => (
      ...
      {[
         {
          ...
          image: "assets/images/cta/cta1.jpg",
          link: "tour-details",
        },
        {
        ...
        },
        {
          ...
          image: "assets/images/cta/cta2.jpg",
          link: "tour-details",
        },
        {
          description: "Rock Climbing ",
          image: "assets/images/cta/cta3.jpg",
          link: "tour-details",
        },
        {
          description: "Sking Adventure ",
          image: "assets/images/cta/cta3.jpg",
          link: "tour-details",
        },
        {
          description: "Moutain Biking ",
          image: "assets/images/cta/cta3.jpg",
          link: "tour-details",
        },
      ].map((cta, index) => (
        ...
        >
          ...
          >
            <h2>{cta.description}</h2>
            <Link
              href={cta.link}
              className={`theme-btn style-two ${
                index % 2 === 0 ? "bgc-secondary" : ""
              }`}
            >
        ...
        <div className="container-fluid">
          <div className="row justify-content-center">
            <div className="col-lg-12">
              ...
              >
                <SectionTitle
                  title={"Discover the Pakistan's Treasures with Mountain Travels Pakistan"}
                  countValue={500}
                  subtitle1={"One site"}
  ...
  {[
    {
      ...
      description: "Blue lake water view taken travel with daytime",
    ...
    },
    {
      ...
      location: "Rome, Italy",
      description: "Woman standing near Colosseum, Rome",
      time: "3 days 2 nights - Couple",
      price: "$42",
      link: "destination-details",
    },
    ...
    >
      <div className="destination-item">
        ...
        <div className="content">
          ...
          <h5>
            <Link href={destination.link}>{destination.description}</Link>
          </h5>
          ...
          <div className="popular-destinations-wrap br-20 bgc-lighter pt-100 pb-70">
            <div className="row justify-content-center">
              <div className="col-lg-12">
                ...
                >
                  <SectionTitle
                    title={"Explore Popular Destinations in Pakistan"}
