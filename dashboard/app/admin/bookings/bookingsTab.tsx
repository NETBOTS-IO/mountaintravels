                ...
                {bookings && bookings.length > 0 ? (
                  bookings.map((booking) => (
                    <tr key={booking._id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        {booking.departureId ? getDepartureDate(booking.departureId) : "No departure selected"}
                      </td>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div className="flex items-center space-x-2">
                          ...
                          {booking.status === "PENDING" && (
                            <button
                              onClick={() =>
                                handleUpdateBookingStatus(booking._id, "CONFIRMED", "PAID")
                              }
                          ...
                          {booking.status !== "CANCELLED" && (
                            <button
                              onClick={() =>
                                handleUpdateBookingStatus(booking._id, "CANCELLED", "REFUNDED")
                              }
          ...
          <div className="md:hidden">
            {bookings && bookings.length > 0 ? (
              <div className="space-y-4 p-4">
                {bookings.map((booking) => (
                  <div key={booking._id} className="border rounded-lg p-4 shadow-sm bg-white">
                    ...
                    <p className="text-sm text-gray-600 mt-2">
                      Trip: {getTripName(booking.tripId)} | Departure:{" "}
                      {booking.departureId ? getDepartureDate(booking.departureId) : "TBD"}
                    </p>
                    <p className="text-sm text-gray-600">
                      Travelers: {booking.travelers} | Total: {formatCurrency(booking.totalPrice)}
                    </p>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <span
                        className={getStatusBadge(selectedBooking.status, "booking")}
                      >
                    ...
                    <div>
                      ...
                      <span
                        className={getStatusBadge(selectedBooking.paymentStatus, "payment")}
                      >
